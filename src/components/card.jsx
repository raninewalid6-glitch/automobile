      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex justify-between items-center mb-8">
          <p className="text-gray-500 dark:text-gray-400">
            {filteredCars.length} {t("card.found")}
          </p>
              ...
              <div className="bg-gray-50 dark:bg-gradient-to-br dark:from-gray-900 dark:to-gray-800 rounded-2xl overflow-hidden border border-gray-200 dark:border-gray-700 hover:border-red-500/50 transition-all duration-300">
                ...
                <div className="p-6">
                  ...
                  <div className="grid grid-cols-2 gap-2 mb-4">
                    {[
                      { label: t("card.seats"), value: car.specs.seats },
                      { label: t("card.doors"), value: car.specs.doors },
                      { label: t("card.fuel"), value: car.specs.fuel },
                      { label: t("card.ac"), value: car.specs.ac },
                    ].map((spec) => (
                  ...
                  <div className="mb-3">
                    <div className="text-xs text-gray-500 dark:text-gray-400">{t("card.rent")}</div>
                    <div className="text-sm font-semibold text-orange-500">
                      {car.pricePerDay != null ? `${car.pricePerDay.toLocaleString()} ${t("card.perDay")}` : "—"}
                    </div>
                  </div>

                  <div className="flex justify-between items-end">
                    <div>
                      <div className="text-xs text-gray-500 dark:text-gray-400 mb-1">{t("card.buyPrice")}</div>
